                        ...
                        <tbody>
                            <?php foreach($areas as $areaItem): ?>
                                <tr>
                                    ...
                                    <td><a href="<?=$base;?>/app/predios/edit_area/<?=$areaItem->id;?>" class="btn btn-outline-success btn-sm" title="Editar Dados"><i class="fa fa-pen"></i></a> <a href="<?=$base;?>/app/predios/delete_area?id=<?=$areaItem->id;?>" class="btn btn-outline-danger btn-sm" title="Excluir"><i class="fa fa-trash"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
